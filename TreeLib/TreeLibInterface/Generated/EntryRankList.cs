...
namespace TreeLib
{
    ...
    public struct EntryRankList<[Feature(Feature.Dict, Feature.Rank, Feature.RankMulti)] KeyType>
    {
        ...
        public EntryRankList(            [Feature(Feature.Dict, Feature.Rank, Feature.RankMulti)] KeyType key,            [Feature(Feature.Rank, Feature.RankMulti, Feature.Range, Feature.Range2)][Widen] int xStart)
        {
            this.key = key;
            this.xStart = xStart;
        }
        ...
        {
            EntryRankList</*[Feature(Feature.Dict, Feature.Rank, Feature.RankMulti)]*/KeyType> other
                = (EntryRankList</*[Feature(Feature.Dict, Feature.Rank, Feature.RankMulti)]*/KeyType>)obj;
