...
namespace TreeLib
{
    ...
    /// </summary>
    public struct EntryRankMapLong<[Feature(Feature.Dict, Feature.Rank, Feature.RankMulti)] KeyType, [Payload(Payload.Value)] ValueType> :
        /*[Payload(Payload.Value)]*/IGetEnumeratorSetValueInfo<ValueType>
    {
        ...
        public EntryRankMapLong(            [Feature(Feature.Dict, Feature.Rank, Feature.RankMulti)] KeyType key,            [Payload(Payload.Value)] ValueType value,            [Payload(Payload.Value)] ISetValue<ValueType> enumerator,            [Payload(Payload.Value)] uint version,            [Feature(Feature.Rank, Feature.RankMulti, Feature.Range, Feature.Range2)][Widen] long xStart)
        {
            this.key = key;
            this.value = value;
            this.xStart = xStart;
        ...
        [Payload(Payload.Value)]
        public EntryRankMapLong(            [Feature(Feature.Dict, Feature.Rank, Feature.RankMulti)] KeyType key,            [Payload(Payload.Value)] ValueType value,            [Feature(Feature.Rank, Feature.RankMulti, Feature.Range, Feature.Range2)][Widen] long xStart)
        {
            this.key = key;
            this.value = value;
            this.xStart = xStart;
        ...
        {
            EntryRankMapLong</*[Feature(Feature.Dict, Feature.Rank, Feature.RankMulti)]*/KeyType, /*[Payload(Payload.Value)]*/ValueType> other
                = (EntryRankMapLong</*[Feature(Feature.Dict, Feature.Rank, Feature.RankMulti)]*/KeyType, /*[Payload(Payload.Value)]*/ValueType>)obj;
