...
namespace TreeLib
{
    ...
    /// </summary>
    public struct EntryMultiRankList<[Feature(Feature.Dict, Feature.Rank, Feature.RankMulti)] KeyType>
    {
        ...
        public EntryMultiRankList(            [Feature(Feature.Dict, Feature.Rank, Feature.RankMulti)] KeyType key,            [Feature(Feature.Rank, Feature.RankMulti, Feature.Range, Feature.Range2)][Widen] int xStart,            [Feature(Feature.RankMulti, Feature.Range, Feature.Range2)][Widen] int xLength)
        {
            this.key = key;
            this.xStart = xStart;
        ...
        {
            EntryMultiRankList</*[Feature(Feature.Dict, Feature.Rank, Feature.RankMulti)]*/KeyType> other
                = (EntryMultiRankList</*[Feature(Feature.Dict, Feature.Rank, Feature.RankMulti)]*/KeyType>)obj;
