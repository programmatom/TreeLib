...
namespace TreeLib
{
    ...
    /// </summary>
    public struct EntryMultiRankListLong<[Feature(Feature.Dict, Feature.Rank, Feature.RankMulti)] KeyType>
    {
        ...
        public EntryMultiRankListLong(            [Feature(Feature.Dict, Feature.Rank, Feature.RankMulti)] KeyType key,            [Feature(Feature.Rank, Feature.RankMulti, Feature.Range, Feature.Range2)][Widen] long xStart,            [Feature(Feature.RankMulti, Feature.Range, Feature.Range2)][Widen] long xLength)
        {
            this.key = key;
            this.xStart = xStart;
        ...
        {
            EntryMultiRankListLong</*[Feature(Feature.Dict, Feature.Rank, Feature.RankMulti)]*/KeyType> other
                = (EntryMultiRankListLong</*[Feature(Feature.Dict, Feature.Rank, Feature.RankMulti)]*/KeyType>)obj;
