...
namespace TreeLib
{
    ...
    /// </summary>
    public struct EntryMultiRankMapLong<[Feature(Feature.Dict, Feature.Rank, Feature.RankMulti)] KeyType, [Payload(Payload.Value)] ValueType> :
        /*[Payload(Payload.Value)]*/IGetEnumeratorSetValueInfo<ValueType>
    {
        ...
        {
            EntryMultiRankMapLong</*[Feature(Feature.Dict, Feature.Rank, Feature.RankMulti)]*/KeyType, /*[Payload(Payload.Value)]*/ValueType> other
                = (EntryMultiRankMapLong</*[Feature(Feature.Dict, Feature.Rank, Feature.RankMulti)]*/KeyType, /*[Payload(Payload.Value)]*/ValueType>)obj;
