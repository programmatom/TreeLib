...
namespace TreeLib
{
        ...
        where KeyType : IComparable<KeyType>
    {
        ...
        public struct RobustEnumerableSurrogate : IEnumerable<EntryMultiRankList<KeyType>>
        {
            ...
            public RobustEnumerableSurrogate(SplayTreeMultiRankList<KeyType> tree)
            {
                this.tree = tree;
            }
        ...
        public struct FastEnumerableSurrogate : IEnumerable<EntryMultiRankList<KeyType>>
        {
            ...
            public FastEnumerableSurrogate(SplayTreeMultiRankList<KeyType> tree)
            {
                this.tree = tree;
            }
        ...
        public class RobustEnumerator : IEnumerator<EntryMultiRankList<KeyType>>
        {
            ...
            public RobustEnumerator(SplayTreeMultiRankList<KeyType> tree)
            {
                this.tree = tree;
                Reset();
            }
        ...
        public class FastEnumerator : IEnumerator<EntryMultiRankList<KeyType>>
        {
            ...
            public FastEnumerator(SplayTreeMultiRankList<KeyType> tree)
            {
                this.tree = tree;
                Reset();
            }
