...
namespace TreeLib
{
    ...
    public class SplayTreeMultiRankList<[Feature(Feature.Dict, Feature.Rank, Feature.RankMulti)] KeyType> :
        ...
        where KeyType : IComparable<KeyType>
    {
        ...
        [Storage(Storage.Object)]
        public SplayTreeMultiRankList([Feature(Feature.Dict, Feature.Rank, Feature.RankMulti)] IComparer<KeyType> comparer,uint capacity,AllocationMode allocationMode)
        {
        ...
        [Storage(Storage.Object)]
        [Feature(Feature.Dict, Feature.Rank, Feature.RankMulti)]
        public SplayTreeMultiRankList(uint capacity,AllocationMode allocationMode)
        ...
        [Storage(Storage.Object)]
        [Feature(Feature.Dict, Feature.Rank, Feature.RankMulti)]
        public SplayTreeMultiRankList([Feature(Feature.Dict, Feature.Rank, Feature.RankMulti)] IComparer<KeyType> comparer)
        ...
        [Storage(Storage.Object)]
        public SplayTreeMultiRankList(SplayTreeMultiRankList<KeyType> original)
        {
        ...
        [Feature(Feature.Rank, Feature.RankMulti)]
        public bool TryAdd(KeyType key,[Feature(Feature.RankMulti)][Widen] int rankCount)
        {
        ...
        {
            private readonly SplayTreeMultiRankList<KeyType> tree;
            ...
            public RobustEnumerableSurrogate(SplayTreeMultiRankList<KeyType> tree,bool forward)
            {
                this.tree = tree;
            ...
            [Feature(Feature.Dict, Feature.Rank, Feature.RankMulti)]
            public RobustEnumerableSurrogate(SplayTreeMultiRankList<KeyType> tree,KeyType startKey,bool forward)
            {
                this.tree = tree;
                this.forward = forward;
        ...
        public struct FastEnumerableSurrogate : IEnumerable<EntryMultiRankList<KeyType>>
        {
            ...
            public FastEnumerableSurrogate(SplayTreeMultiRankList<KeyType> tree,bool forward)
            {
                this.tree = tree;
                this.forward = forward;
            ...
            [Feature(Feature.Dict, Feature.Rank, Feature.RankMulti)]
            public FastEnumerableSurrogate(SplayTreeMultiRankList<KeyType> tree,KeyType startKey,bool forward)
            {
                this.tree = tree;
                this.forward = forward;
        ...
        public class RobustEnumerator :
            ...
            public RobustEnumerator(SplayTreeMultiRankList<KeyType> tree,bool forward)
            {
                this.tree = tree;
                this.forward = forward;
            ...
            [Feature(Feature.Dict, Feature.Rank, Feature.RankMulti)]
            public RobustEnumerator(SplayTreeMultiRankList<KeyType> tree,KeyType startKey,bool forward)
            {
                this.tree = tree;
                this.forward = forward;
        ...
        public class FastEnumerator :
            ...
            public FastEnumerator(SplayTreeMultiRankList<KeyType> tree,bool forward)
            {
                this.tree = tree;
                this.forward = forward;
            ...
            [Feature(Feature.Dict, Feature.Rank, Feature.RankMulti)]
            public FastEnumerator(SplayTreeMultiRankList<KeyType> tree,KeyType startKey,bool forward)
            {
                this.tree = tree;
                this.forward = forward;
        ...
        public object Clone()
        {
            return new SplayTreeMultiRankList<KeyType>(this);
        }
    }
}
