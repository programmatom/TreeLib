...
namespace TreeLib
{
    ...
    public class SplayTreeMultiRankMap<[Feature(Feature.Dict, Feature.Rank, Feature.RankMulti)] KeyType, [Payload(Payload.Value)] ValueType> :
        ...
        where KeyType : IComparable<KeyType>
    {
        ...
        [Storage(Storage.Object)]
        public SplayTreeMultiRankMap([Feature(Feature.Dict, Feature.Rank, Feature.RankMulti)] IComparer<KeyType> comparer,uint capacity,AllocationMode allocationMode)
        {
        ...
        [Storage(Storage.Object)]
        [Feature(Feature.Dict, Feature.Rank, Feature.RankMulti)]
        public SplayTreeMultiRankMap(uint capacity,AllocationMode allocationMode)
        ...
        [Storage(Storage.Object)]
        [Feature(Feature.Dict, Feature.Rank, Feature.RankMulti)]
        public SplayTreeMultiRankMap([Feature(Feature.Dict, Feature.Rank, Feature.RankMulti)] IComparer<KeyType> comparer)
        ...
        [Storage(Storage.Object)]
        public SplayTreeMultiRankMap(SplayTreeMultiRankMap<KeyType, ValueType> original)
        {
        ...
        [Feature(Feature.Dict, Feature.Rank, Feature.RankMulti)]
        private bool TrySetOrAddInternal(            KeyType key,            [Payload(Payload.Value)]ValueType value,            [Feature(Feature.RankMulti)][Const(1, Feature.Dict, Feature.Rank)][SuppressConst(Feature.RankMulti)][Widen]int rankCount,            bool updateExisting)
        {
            unchecked
            {
                if (rankCount <= 0)
        ...
        {
            private readonly SplayTreeMultiRankMap<KeyType, ValueType> tree;
            ...
            public RobustEnumerableSurrogate(SplayTreeMultiRankMap<KeyType, ValueType> tree,bool forward)
            {
                this.tree = tree;
            ...
            [Feature(Feature.Dict, Feature.Rank, Feature.RankMulti)]
            public RobustEnumerableSurrogate(SplayTreeMultiRankMap<KeyType, ValueType> tree,KeyType startKey,bool forward)
            {
                this.tree = tree;
                this.forward = forward;
        ...
        public struct FastEnumerableSurrogate : IEnumerable<EntryMultiRankMap<KeyType, ValueType>>
        {
            ...
            public FastEnumerableSurrogate(SplayTreeMultiRankMap<KeyType, ValueType> tree,bool forward)
            {
                this.tree = tree;
                this.forward = forward;
            ...
            [Feature(Feature.Dict, Feature.Rank, Feature.RankMulti)]
            public FastEnumerableSurrogate(SplayTreeMultiRankMap<KeyType, ValueType> tree,KeyType startKey,bool forward)
            {
                this.tree = tree;
                this.forward = forward;
            ...
            /*[Payload(Payload.Value)]*/ISetValue<ValueType>
        {
            ...
            public RobustEnumerator(SplayTreeMultiRankMap<KeyType, ValueType> tree,bool forward)
            {
                this.tree = tree;
                this.forward = forward;
            ...
            [Feature(Feature.Dict, Feature.Rank, Feature.RankMulti)]
            public RobustEnumerator(SplayTreeMultiRankMap<KeyType, ValueType> tree,KeyType startKey,bool forward)
            {
                this.tree = tree;
                this.forward = forward;
            ...
            /*[Payload(Payload.Value)]*/ISetValue<ValueType>
        {
            ...
            public FastEnumerator(SplayTreeMultiRankMap<KeyType, ValueType> tree,bool forward)
            {
                this.tree = tree;
                this.forward = forward;
            ...
            [Feature(Feature.Dict, Feature.Rank, Feature.RankMulti)]
            public FastEnumerator(SplayTreeMultiRankMap<KeyType, ValueType> tree,KeyType startKey,bool forward)
            {
                this.tree = tree;
                this.forward = forward;
        ...
        public object Clone()
        {
            return new SplayTreeMultiRankMap<KeyType, ValueType>(this);
        }
    }
}
