...
namespace TreeLib
{
        ...
        where KeyType : IComparable<KeyType>
    {
        ...
        public struct RobustEnumerableSurrogate : IEnumerable<EntryMultiRankMap<KeyType, ValueType>>
        {
            ...
            public RobustEnumerableSurrogate(SplayTreeMultiRankMap<KeyType, ValueType> tree)
            {
                this.tree = tree;
            }
        ...
        public struct FastEnumerableSurrogate : IEnumerable<EntryMultiRankMap<KeyType, ValueType>>
        {
            ...
            public FastEnumerableSurrogate(SplayTreeMultiRankMap<KeyType, ValueType> tree)
            {
                this.tree = tree;
            }
        ...
        public class RobustEnumerator : IEnumerator<EntryMultiRankMap<KeyType, ValueType>>
        {
            ...
            public RobustEnumerator(SplayTreeMultiRankMap<KeyType, ValueType> tree)
            {
                this.tree = tree;
                Reset();
            }
        ...
        public class FastEnumerator : IEnumerator<EntryMultiRankMap<KeyType, ValueType>>
        {
            ...
            public FastEnumerator(SplayTreeMultiRankMap<KeyType, ValueType> tree)
            {
                this.tree = tree;
                Reset();
            }
