...
namespace TreeLib
{
    ...
    public class RedBlackTreeRange2Map<[Payload(Payload.Value)] ValueType> :
        ...
        ICloneable
    {
        ...
        private Node Null { get { return RedBlackTreeRange2Map<ValueType>._Null; } } // allow tree.Null or this.Null in all cases
        ...
        [Storage(Storage.Object)]
        public RedBlackTreeRange2Map(uint capacity,AllocationMode allocationMode)
        {
            this.root = Null;
        ...
        [Storage(Storage.Object)]
        public RedBlackTreeRange2Map(RedBlackTreeRange2Map<ValueType> original)
        {
        ...
        private bool InsertUpdateInternal(            [Payload(Payload.Value)] ValueType value,            [Feature(Feature.Rank, Feature.RankMulti, Feature.Range, Feature.Range2)][Widen] int position,            [Feature(Feature.Range2)] [Const(Side.X, Feature.Rank, Feature.RankMulti, Feature.Range)] [SuppressConst(Feature.Range2)] Side side,            [Feature(Feature.Rank, Feature.RankMulti, Feature.Range, Feature.Range2)][Widen] int xLength,            [Feature(Feature.Range2)][Widen] int yLength,            bool add,            bool update)
        {
        ...
        private bool DeleteInternal(            [Feature(Feature.Rank, Feature.RankMulti, Feature.Range, Feature.Range2)][Widen] int position,            [Feature(Feature.Range2)] [Const(Side.X, Feature.Rank, Feature.RankMulti, Feature.Range)] [SuppressConst(Feature.Range2)] Side side)
        {
            unchecked
            {
                if (root == Null)
                ...
                while (current != Null)
                {
                    ...
                    if (Is2Node(current))
                    {
                        ...
                        else
                        {
                            ...
                            /*[Feature(Feature.Range2)]*/
                            /*[Widen]*/
                            int yPositionSibling = yPositionParent + sibling.yOffset;
                            if (sibling.isRed)
                            {
                            ...
                            else
                            {
                                ...
                                /*[Feature(Feature.Range2)]*/
                                /*[Widen]*/
                                int yPositionNewGrandparent = yPositionParent - parent.yOffset;
                                switch (rotation)
                                {
                                    default:
                                        Debug.Assert(false);
        ...
        private void ReplaceNode(            Node match,            Node parentOfMatch,            Node successor,            [Feature(Feature.Rank, Feature.RankMulti, Feature.Range, Feature.Range2)][Widen] int xOffsetMatchSuccessor,            [Feature(Feature.Range2)][Widen] int yOffsetMatchSuccessor,            Node parentOfsuccessor)
        {
            unchecked
            {
                if (successor == match)
        ...
        private Node RotateLeftRight(Node node)
        {
            unchecked
            {
                ...
                /*[Feature(Feature.Range2)]*/
                /*[Widen]*/
                int yOffsetNode = node.yOffset;
                /*[Feature(Feature.Rank, Feature.RankMulti, Feature.Range, Feature.Range2)]*/
                /*[Widen]*/
                int xOffsetLChild = lChild.xOffset;
                /*[Feature(Feature.Range2)]*/
                /*[Widen]*/
                int yOffsetLChild = lChild.yOffset;
                /*[Feature(Feature.Rank, Feature.RankMulti, Feature.Range, Feature.Range2)]*/
                /*[Widen]*/
                int xOffsetLRGrandchild = lrGrandChild.xOffset;
                /*[Feature(Feature.Range2)]*/
                /*[Widen]*/
                int yOffsetLRGrandchild = lrGrandChild.yOffset;
        ...
        private Node RotateRightLeft(Node node)
        {
            unchecked
            {
                ...
                /*[Feature(Feature.Range2)]*/
                /*[Widen]*/
                int yOffsetRChild = rChild.yOffset;
                /*[Feature(Feature.Rank, Feature.RankMulti, Feature.Range, Feature.Range2)]*/
                /*[Widen]*/
                int xOffsetRLGrandchild = rlGrandChild.xOffset;
                /*[Feature(Feature.Range2)]*/
                /*[Widen]*/
                int yOffsetRLGrandchild = rlGrandChild.yOffset;
        ...
        {
            private readonly RedBlackTreeRange2Map<ValueType> tree;
            ...
            public RobustEnumerableSurrogate(RedBlackTreeRange2Map<ValueType> tree,bool forward)
            {
                this.tree = tree;
            ...
            [Feature(Feature.Range, Feature.Range2)]
            public RobustEnumerableSurrogate(RedBlackTreeRange2Map<ValueType> tree,[Widen] int startStart,[Feature(Feature.Range2)] [Const(Side.X, Feature.Range)] [SuppressConst(Feature.Range2)] Side side,bool forward)
            {
                this.tree = tree;
                this.forward = forward;
        ...
        public struct FastEnumerableSurrogate : IEnumerable<EntryRange2Map<ValueType>>
        {
            ...
            public FastEnumerableSurrogate(RedBlackTreeRange2Map<ValueType> tree,bool forward)
            {
                this.tree = tree;
                this.forward = forward;
            ...
            [Feature(Feature.Range, Feature.Range2)]
            public FastEnumerableSurrogate(RedBlackTreeRange2Map<ValueType> tree,[Widen] int startStart,[Feature(Feature.Range2)] [Const(Side.X, Feature.Range)] [SuppressConst(Feature.Range2)] Side side,bool forward)
            {
                this.tree = tree;
                this.forward = forward;
            ...
            /*[Payload(Payload.Value)]*/ISetValue<ValueType>
        {
            ...
            public RobustEnumerator(RedBlackTreeRange2Map<ValueType> tree,bool forward)
            {
                this.tree = tree;
                this.forward = forward;
            ...
            [Feature(Feature.Range, Feature.Range2)]
            public RobustEnumerator(RedBlackTreeRange2Map<ValueType> tree,[Widen] int startStart,[Feature(Feature.Range2)] [Const(Side.X, Feature.Range)] [SuppressConst(Feature.Range2)] Side side,bool forward)
            {
                this.tree = tree;
                this.forward = forward;
            ...
            /*[Payload(Payload.Value)]*/ISetValue<ValueType>
        {
            ...
            public FastEnumerator(RedBlackTreeRange2Map<ValueType> tree,bool forward)
            {
                this.tree = tree;
                this.forward = forward;
            ...
            [Feature(Feature.Range, Feature.Range2)]
            public FastEnumerator(RedBlackTreeRange2Map<ValueType> tree,[Widen] int startStart,[Feature(Feature.Range2)] [Const(Side.X, Feature.Range)] [SuppressConst(Feature.Range2)] Side side,bool forward)
            {
                this.tree = tree;
                this.forward = forward;
        ...
        public object Clone()
        {
            return new RedBlackTreeRange2Map<ValueType>(this);
        }
    }
}
