...
namespace TreeLib
{
        ...
        ICloneable
    {
        ...
        private Node Null { get { return AVLTreeRangeList._Null; } } // allow tree.Null or this.Null in all cases
...
out length))
        ...
        public struct RobustEnumerableSurrogate : IEnumerable<EntryRangeList>
        {
            ...
            public RobustEnumerableSurrogate(AVLTreeRangeList tree)
            {
                this.tree = tree;
            }
        ...
        public struct FastEnumerableSurrogate : IEnumerable<EntryRangeList>
        {
            ...
            public FastEnumerableSurrogate(AVLTreeRangeList tree)
            {
                this.tree = tree;
            }
        ...
        public class RobustEnumerator : IEnumerator<EntryRangeList>
        {
            ...
            public RobustEnumerator(AVLTreeRangeList tree)
            {
                this.tree = tree;
                Reset();
            }
        ...
        public class FastEnumerator : IEnumerator<EntryRangeList>
        {
            ...
            public FastEnumerator(AVLTreeRangeList tree)
            {
                this.tree = tree;
                Reset();
            }
