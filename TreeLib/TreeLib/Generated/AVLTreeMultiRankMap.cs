...
/*[Feature(Feature.RankMulti)]*/out xLength))
        ...
        public struct RobustEnumerableSurrogate : IEnumerable<EntryMultiRankMap<KeyType, ValueType>>
        {
            ...
            public RobustEnumerableSurrogate(AVLTreeMultiRankMap<KeyType, ValueType> tree)
            {
                this.tree = tree;
            }
        ...
        public struct FastEnumerableSurrogate : IEnumerable<EntryMultiRankMap<KeyType, ValueType>>
        {
            ...
            public FastEnumerableSurrogate(AVLTreeMultiRankMap<KeyType, ValueType> tree)
            {
                this.tree = tree;
            }
        ...
        public class RobustEnumerator : IEnumerator<EntryMultiRankMap<KeyType, ValueType>>
        {
            ...
            public RobustEnumerator(AVLTreeMultiRankMap<KeyType, ValueType> tree)
            {
                this.tree = tree;
                Reset();
            }
        ...
        public class FastEnumerator : IEnumerator<EntryMultiRankMap<KeyType, ValueType>>
        {
            ...
            public FastEnumerator(AVLTreeMultiRankMap<KeyType, ValueType> tree)
            {
                this.tree = tree;
                Reset();
            }
