...
out length))
        ...
        public struct RobustEnumerableSurrogate : IEnumerable<EntryRangeMap<ValueType>>
        {
            ...
            public RobustEnumerableSurrogate(AVLTreeRangeMap<ValueType> tree)
            {
                this.tree = tree;
            }
        ...
        public struct FastEnumerableSurrogate : IEnumerable<EntryRangeMap<ValueType>>
        {
            ...
            public FastEnumerableSurrogate(AVLTreeRangeMap<ValueType> tree)
            {
                this.tree = tree;
            }
        ...
        public class RobustEnumerator : IEnumerator<EntryRangeMap<ValueType>>
        {
            ...
            public RobustEnumerator(AVLTreeRangeMap<ValueType> tree)
            {
                this.tree = tree;
                Reset();
            }
        ...
        public class FastEnumerator : IEnumerator<EntryRangeMap<ValueType>>
        {
            ...
            public FastEnumerator(AVLTreeRangeMap<ValueType> tree)
            {
                this.tree = tree;
                Reset();
            }
