...
namespace TreeLib
{
    ...
    public class AVLTreeRangeMap<[Payload(Payload.Value)] ValueType> :
        ...
        ICloneable
    {
        ...
        [Storage(Storage.Object)]
        public AVLTreeRangeMap(uint capacity,AllocationMode allocationMode)
        {
            this.root = Null;
        ...
        [Storage(Storage.Object)]
        public AVLTreeRangeMap(AVLTreeRangeMap<ValueType> original)
        {
...
out length))
        ...
        private bool NearestLess(
            out Node nearestNode,            [Feature(Feature.Rank, Feature.RankMulti, Feature.Range, Feature.Range2)][Widen] int position,            [Feature(Feature.Rank, Feature.RankMulti, Feature.Range, Feature.Range2)][Widen] out int nearestStart,            bool orEqual)
        {
            unchecked
            {
                Node lastLess = Null;
        ...
        {
            private readonly AVLTreeRangeMap<ValueType> tree;
            ...
            public RobustEnumerableSurrogate(AVLTreeRangeMap<ValueType> tree,bool forward)
            {
                this.tree = tree;
            ...
            [Feature(Feature.Range, Feature.Range2)]
            public RobustEnumerableSurrogate(AVLTreeRangeMap<ValueType> tree,[Widen] int startStart,bool forward)
            {
                this.tree = tree;
                this.forward = forward;
        ...
        public struct FastEnumerableSurrogate : IEnumerable<EntryRangeMap<ValueType>>
        {
            ...
            public FastEnumerableSurrogate(AVLTreeRangeMap<ValueType> tree,bool forward)
            {
                this.tree = tree;
                this.forward = forward;
            ...
            [Feature(Feature.Range, Feature.Range2)]
            public FastEnumerableSurrogate(AVLTreeRangeMap<ValueType> tree,[Widen] int startStart,bool forward)
            {
                this.tree = tree;
                this.forward = forward;
            ...
            /*[Payload(Payload.Value)]*/ISetValue<ValueType>
        {
            ...
            public RobustEnumerator(AVLTreeRangeMap<ValueType> tree,bool forward)
            {
                this.tree = tree;
                this.forward = forward;
            ...
            [Feature(Feature.Range, Feature.Range2)]
            public RobustEnumerator(AVLTreeRangeMap<ValueType> tree,[Widen] int startStart,bool forward)
            {
                this.tree = tree;
                this.forward = forward;
            ...
            /*[Payload(Payload.Value)]*/ISetValue<ValueType>
        {
            ...
            public FastEnumerator(AVLTreeRangeMap<ValueType> tree,bool forward)
            {
                this.tree = tree;
                this.forward = forward;
            ...
            [Feature(Feature.Range, Feature.Range2)]
            public FastEnumerator(AVLTreeRangeMap<ValueType> tree,[Widen] int startStart,bool forward)
            {
                this.tree = tree;
                this.forward = forward;
        ...
        public object Clone()
        {
            return new AVLTreeRangeMap<ValueType>(this);
        }
    }
}
