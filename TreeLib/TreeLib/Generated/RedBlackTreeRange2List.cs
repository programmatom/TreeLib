...
namespace TreeLib
{
        ...
        IEnumerable
    {
        ...
        public struct RobustEnumerableSurrogate : IEnumerable<EntryRange2List>
        {
            ...
            public RobustEnumerableSurrogate(RedBlackTreeRange2List tree)
            {
                this.tree = tree;
            }
        ...
        public struct FastEnumerableSurrogate : IEnumerable<EntryRange2List>
        {
            ...
            public FastEnumerableSurrogate(RedBlackTreeRange2List tree)
            {
                this.tree = tree;
            }
        ...
        public class RobustEnumerator : IEnumerator<EntryRange2List>
        {
            ...
            public RobustEnumerator(RedBlackTreeRange2List tree)
            {
                this.tree = tree;
                Reset();
            }
        ...
        public class FastEnumerator : IEnumerator<EntryRange2List>
        {
            ...
            public FastEnumerator(RedBlackTreeRange2List tree)
            {
                this.tree = tree;
                Reset();
            }
