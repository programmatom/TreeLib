...
namespace TreeLib
{
    ...
    /// </summary>
    public class RedBlackTreeRange2List:
        ...
        ICloneable
    {
        ...
        private Node Null { get { return RedBlackTreeRange2List._Null; } } // allow tree.Null or this.Null in all cases
        ...
        [Storage(Storage.Object)]
        public RedBlackTreeRange2List(uint capacity,AllocationMode allocationMode)
        {
            this.root = Null;
        ...
        [Storage(Storage.Object)]
        public RedBlackTreeRange2List(RedBlackTreeRange2List original)
        {
        ...
        {
            private readonly RedBlackTreeRange2List tree;
            ...
            public RobustEnumerableSurrogate(RedBlackTreeRange2List tree,bool forward)
            {
                this.tree = tree;
            ...
            [Feature(Feature.Range, Feature.Range2)]
            public RobustEnumerableSurrogate(RedBlackTreeRange2List tree,[Widen] int startStart,[Feature(Feature.Range2)] [Const(Side.X, Feature.Range)] [SuppressConst(Feature.Range2)] Side side,bool forward)
            {
                this.tree = tree;
                this.forward = forward;
        ...
        public struct FastEnumerableSurrogate : IEnumerable<EntryRange2List>
        {
            ...
            public FastEnumerableSurrogate(RedBlackTreeRange2List tree,bool forward)
            {
                this.tree = tree;
                this.forward = forward;
            ...
            [Feature(Feature.Range, Feature.Range2)]
            public FastEnumerableSurrogate(RedBlackTreeRange2List tree,[Widen] int startStart,[Feature(Feature.Range2)] [Const(Side.X, Feature.Range)] [SuppressConst(Feature.Range2)] Side side,bool forward)
            {
                this.tree = tree;
                this.forward = forward;
        ...
        public class RobustEnumerator :
            ...
            public RobustEnumerator(RedBlackTreeRange2List tree,bool forward)
            {
                this.tree = tree;
                this.forward = forward;
            ...
            [Feature(Feature.Range, Feature.Range2)]
            public RobustEnumerator(RedBlackTreeRange2List tree,[Widen] int startStart,[Feature(Feature.Range2)] [Const(Side.X, Feature.Range)] [SuppressConst(Feature.Range2)] Side side,bool forward)
            {
                this.tree = tree;
                this.forward = forward;
        ...
        public class FastEnumerator :
            ...
            [Feature(Feature.Range, Feature.Range2)]
            public FastEnumerator(RedBlackTreeRange2List tree,[Widen] int startStart,[Feature(Feature.Range2)] [Const(Side.X, Feature.Range)] [SuppressConst(Feature.Range2)] Side side,bool forward)
            {
                this.tree = tree;
                this.forward = forward;
        ...
        public object Clone()
        {
            return new RedBlackTreeRange2List(this);
        }
    }
}
