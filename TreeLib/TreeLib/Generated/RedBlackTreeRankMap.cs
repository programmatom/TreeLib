...
namespace TreeLib
{
        ...
        where KeyType : IComparable<KeyType>
    {
        ...
        public struct RobustEnumerableSurrogate : IEnumerable<EntryRankMap<KeyType, ValueType>>
        {
            ...
            public RobustEnumerableSurrogate(RedBlackTreeRankMap<KeyType, ValueType> tree)
            {
                this.tree = tree;
            }
        ...
        public struct FastEnumerableSurrogate : IEnumerable<EntryRankMap<KeyType, ValueType>>
        {
            ...
            public FastEnumerableSurrogate(RedBlackTreeRankMap<KeyType, ValueType> tree)
            {
                this.tree = tree;
            }
        ...
        public class RobustEnumerator : IEnumerator<EntryRankMap<KeyType, ValueType>>
        {
            ...
            public RobustEnumerator(RedBlackTreeRankMap<KeyType, ValueType> tree)
            {
                this.tree = tree;
                Reset();
            }
        ...
        public class FastEnumerator : IEnumerator<EntryRankMap<KeyType, ValueType>>
        {
            ...
            public FastEnumerator(RedBlackTreeRankMap<KeyType, ValueType> tree)
            {
                this.tree = tree;
                Reset();
            }
