...
namespace TreeLib
{
        ...
        ICloneable
    {
        ...
        public struct RobustEnumerableSurrogate : IEnumerable<EntryRangeMap<ValueType>>
        {
            ...
            public RobustEnumerableSurrogate(SplayTreeRangeMap<ValueType> tree,bool forward)
            {
                this.tree = tree;
            ...
            [Feature(Feature.Range, Feature.Range2)]
            public RobustEnumerableSurrogate(SplayTreeRangeMap<ValueType> tree,[Widen] int startStart,bool forward)
            {
                this.tree = tree;
                this.forward = forward;
        ...
        public struct FastEnumerableSurrogate : IEnumerable<EntryRangeMap<ValueType>>
        {
            ...
            public FastEnumerableSurrogate(SplayTreeRangeMap<ValueType> tree,bool forward)
            {
                this.tree = tree;
                this.forward = forward;
            ...
            [Feature(Feature.Range, Feature.Range2)]
            public FastEnumerableSurrogate(SplayTreeRangeMap<ValueType> tree,[Widen] int startStart,bool forward)
            {
                this.tree = tree;
                this.forward = forward;
            ...
            /*[Payload(Payload.Value)]*/ISetValue<ValueType>
        {
            ...
            [Feature(Feature.Range, Feature.Range2)]
            public RobustEnumerator(SplayTreeRangeMap<ValueType> tree,[Widen] int startStart,bool forward)
            {
                this.tree = tree;
                this.forward = forward;
            ...
            /*[Payload(Payload.Value)]*/ISetValue<ValueType>
        {
            ...
            public FastEnumerator(SplayTreeRangeMap<ValueType> tree,bool forward)
            {
                this.tree = tree;
                this.forward = forward;
            ...
            [Feature(Feature.Range, Feature.Range2)]
            public FastEnumerator(SplayTreeRangeMap<ValueType> tree,[Widen] int startStart,bool forward)
            {
                this.tree = tree;
                this.forward = forward;
