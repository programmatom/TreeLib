...
out length))
        ...
        public struct RobustEnumerableSurrogate : IEnumerable<EntryRange2List>
        {
            ...
            public RobustEnumerableSurrogate(AVLTreeRange2List tree)
            {
                this.tree = tree;
            }
        ...
        public struct FastEnumerableSurrogate : IEnumerable<EntryRange2List>
        {
            ...
            public FastEnumerableSurrogate(AVLTreeRange2List tree)
            {
                this.tree = tree;
            }
        ...
        public class RobustEnumerator : IEnumerator<EntryRange2List>
        {
            ...
            public RobustEnumerator(AVLTreeRange2List tree)
            {
                this.tree = tree;
                Reset();
            }
        ...
        public class FastEnumerator : IEnumerator<EntryRange2List>
        {
            ...
            public FastEnumerator(AVLTreeRange2List tree)
            {
                this.tree = tree;
                Reset();
            }
