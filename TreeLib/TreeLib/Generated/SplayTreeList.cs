...
namespace TreeLib
{
        ...
        where KeyType : IComparable<KeyType>
    {
        ...
        public struct RobustEnumerableSurrogate : IEnumerable<EntryList<KeyType>>
        {
            ...
            public RobustEnumerableSurrogate(SplayTreeList<KeyType> tree)
            {
                this.tree = tree;
            }
        ...
        public struct FastEnumerableSurrogate : IEnumerable<EntryList<KeyType>>
        {
            ...
            public FastEnumerableSurrogate(SplayTreeList<KeyType> tree)
            {
                this.tree = tree;
            }
        ...
        public class RobustEnumerator : IEnumerator<EntryList<KeyType>>
        {
            ...
            public RobustEnumerator(SplayTreeList<KeyType> tree)
            {
                this.tree = tree;
                Reset();
            }
        ...
        public class FastEnumerator : IEnumerator<EntryList<KeyType>>
        {
            ...
            public FastEnumerator(SplayTreeList<KeyType> tree)
            {
                this.tree = tree;
                Reset();
            }
