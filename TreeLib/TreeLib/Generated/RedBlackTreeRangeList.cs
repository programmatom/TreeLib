...
namespace TreeLib
{
    ...
    /// </summary>
    public class RedBlackTreeRangeList:
        ...
        ICloneable
    {
        ...
        private Node Null { get { return RedBlackTreeRangeList._Null; } } // allow tree.Null or this.Null in all cases
        ...
        [Storage(Storage.Object)]
        public RedBlackTreeRangeList(uint capacity,AllocationMode allocationMode)
        {
            this.root = Null;
        ...
        [Storage(Storage.Object)]
        public RedBlackTreeRangeList(RedBlackTreeRangeList original)
        {
        ...
        private bool InsertUpdateInternal(            [Feature(Feature.Rank, Feature.RankMulti, Feature.Range, Feature.Range2)][Widen] int position,            [Feature(Feature.Rank, Feature.RankMulti, Feature.Range, Feature.Range2)][Widen] int xLength,            bool add,            bool update)
        {
        ...
        {
            private readonly RedBlackTreeRangeList tree;
            ...
            public RobustEnumerableSurrogate(RedBlackTreeRangeList tree,bool forward)
            {
                this.tree = tree;
            ...
            [Feature(Feature.Range, Feature.Range2)]
            public RobustEnumerableSurrogate(RedBlackTreeRangeList tree,[Widen] int startStart,bool forward)
            {
                this.tree = tree;
                this.forward = forward;
        ...
        public struct FastEnumerableSurrogate : IEnumerable<EntryRangeList>
        {
            ...
            public FastEnumerableSurrogate(RedBlackTreeRangeList tree,bool forward)
            {
                this.tree = tree;
                this.forward = forward;
            ...
            [Feature(Feature.Range, Feature.Range2)]
            public FastEnumerableSurrogate(RedBlackTreeRangeList tree,[Widen] int startStart,bool forward)
            {
                this.tree = tree;
                this.forward = forward;
        ...
        public class RobustEnumerator :
            ...
            public RobustEnumerator(RedBlackTreeRangeList tree,bool forward)
            {
                this.tree = tree;
                this.forward = forward;
            ...
            [Feature(Feature.Range, Feature.Range2)]
            public RobustEnumerator(RedBlackTreeRangeList tree,[Widen] int startStart,bool forward)
            {
                this.tree = tree;
                this.forward = forward;
        ...
        public class FastEnumerator :
            ...
            public FastEnumerator(RedBlackTreeRangeList tree,bool forward)
            {
                this.tree = tree;
                this.forward = forward;
            ...
            [Feature(Feature.Range, Feature.Range2)]
            public FastEnumerator(RedBlackTreeRangeList tree,[Widen] int startStart,bool forward)
            {
                this.tree = tree;
                this.forward = forward;
        ...
        public object Clone()
        {
            return new RedBlackTreeRangeList(this);
        }
    }
}
