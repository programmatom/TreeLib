...
namespace TreeLib
{
        ...
        ICloneable
    {
        ...
        public struct RobustEnumerableSurrogate : IEnumerable<EntryRangeList>
        {
            ...
            public RobustEnumerableSurrogate(RedBlackTreeRangeList tree)
            {
                this.tree = tree;
            }
        ...
        public struct FastEnumerableSurrogate : IEnumerable<EntryRangeList>
        {
            ...
            public FastEnumerableSurrogate(RedBlackTreeRangeList tree)
            {
                this.tree = tree;
            }
        ...
        public class RobustEnumerator : IEnumerator<EntryRangeList>
        {
            ...
            public RobustEnumerator(RedBlackTreeRangeList tree)
            {
                this.tree = tree;
                Reset();
            }
        ...
        public class FastEnumerator : IEnumerator<EntryRangeList>
        {
            ...
            public FastEnumerator(RedBlackTreeRangeList tree)
            {
                this.tree = tree;
                Reset();
            }
