...
namespace TreeLib
{
        ...
        IEnumerable
    {
        ...
        public struct RobustEnumerableSurrogate : IEnumerable<EntryRangeList>
        {
            ...
            public RobustEnumerableSurrogate(SplayTreeRangeList tree)
            {
                this.tree = tree;
            }
        ...
        public struct FastEnumerableSurrogate : IEnumerable<EntryRangeList>
        {
            ...
            public FastEnumerableSurrogate(SplayTreeRangeList tree)
            {
                this.tree = tree;
            }
        ...
        public class RobustEnumerator : IEnumerator<EntryRangeList>
        {
            ...
            public RobustEnumerator(SplayTreeRangeList tree)
            {
                this.tree = tree;
                Reset();
            }
        ...
        public class FastEnumerator : IEnumerator<EntryRangeList>
        {
            ...
            public FastEnumerator(SplayTreeRangeList tree)
            {
                this.tree = tree;
                Reset();
            }
