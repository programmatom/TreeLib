...
namespace TreeLib
{
    ...
    public class SplayTreeRankList<[Feature(Feature.Dict, Feature.Rank, Feature.RankMulti)] KeyType> :
        ...
        where KeyType : IComparable<KeyType>
    {
        ...
        [Storage(Storage.Object)]
        [Feature(Feature.Dict, Feature.Rank, Feature.RankMulti)]
        public SplayTreeRankList([Feature(Feature.Dict, Feature.Rank, Feature.RankMulti)] IComparer<KeyType> comparer)
        ...
        [Storage(Storage.Object)]
        public SplayTreeRankList(SplayTreeRankList<KeyType> original)
        {
        ...
        {
            private readonly SplayTreeRankList<KeyType> tree;

            public RobustEnumerableSurrogate(SplayTreeRankList<KeyType> tree)
            {
                this.tree = tree;
            }
        ...
        public struct FastEnumerableSurrogate : IEnumerable<EntryRankList<KeyType>>
        {
            ...
            public FastEnumerableSurrogate(SplayTreeRankList<KeyType> tree)
            {
                this.tree = tree;
            }
        ...
        public class RobustEnumerator : IEnumerator<EntryRankList<KeyType>>
        {
            ...
            public RobustEnumerator(SplayTreeRankList<KeyType> tree)
            {
                this.tree = tree;
                Reset();
            }
        ...
        public class FastEnumerator : IEnumerator<EntryRankList<KeyType>>
        {
            ...
            public FastEnumerator(SplayTreeRankList<KeyType> tree)
            {
                this.tree = tree;
                Reset();
            }
        ...
        public object Clone()
        {
            return new SplayTreeRankList<KeyType>(this);
        }
    }
}
