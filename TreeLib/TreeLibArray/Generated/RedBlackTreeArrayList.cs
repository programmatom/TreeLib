...
uint countNew = checked(this.count + 1);
        ...
        public struct RobustEnumerableSurrogate : IEnumerable<EntryList<KeyType>>
        {
            ...
            public RobustEnumerableSurrogate(RedBlackTreeArrayList<KeyType> tree,bool forward)
            {
                this.tree = tree;
            ...
            [Feature(Feature.Dict, Feature.Rank, Feature.RankMulti)]
            public RobustEnumerableSurrogate(RedBlackTreeArrayList<KeyType> tree,KeyType startKey,bool forward)
            {
                this.tree = tree;
                this.forward = forward;
        ...
        public struct FastEnumerableSurrogate : IEnumerable<EntryList<KeyType>>
        {
            ...
            public FastEnumerableSurrogate(RedBlackTreeArrayList<KeyType> tree,bool forward)
            {
                this.tree = tree;
                this.forward = forward;
            ...
            [Feature(Feature.Dict, Feature.Rank, Feature.RankMulti)]
            public FastEnumerableSurrogate(RedBlackTreeArrayList<KeyType> tree,KeyType startKey,bool forward)
            {
                this.tree = tree;
                this.forward = forward;
        ...
        public class RobustEnumerator :
            ...
            public RobustEnumerator(RedBlackTreeArrayList<KeyType> tree,bool forward)
            {
                this.tree = tree;
                this.forward = forward;
            ...
            [Feature(Feature.Dict, Feature.Rank, Feature.RankMulti)]
            public RobustEnumerator(RedBlackTreeArrayList<KeyType> tree,KeyType startKey,bool forward)
            {
                this.tree = tree;
                this.forward = forward;
        ...
        public class FastEnumerator :
            ...
            [Feature(Feature.Dict, Feature.Rank, Feature.RankMulti)]
            public FastEnumerator(RedBlackTreeArrayList<KeyType> tree,KeyType startKey,bool forward)
            {
                this.tree = tree;
                this.forward = forward;
        ...
        public object Clone()
        {
            return new RedBlackTreeArrayList<KeyType>(this);
        }
    }
}
