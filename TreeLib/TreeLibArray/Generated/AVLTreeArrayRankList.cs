...
uint countNew = checked(this.count + 1);
        ...
        public struct RobustEnumerableSurrogate : IEnumerable<EntryRankList<KeyType>>
        {
            ...
            public RobustEnumerableSurrogate(AVLTreeArrayRankList<KeyType> tree)
            {
                this.tree = tree;
            }
        ...
        public struct FastEnumerableSurrogate : IEnumerable<EntryRankList<KeyType>>
        {
            ...
            public FastEnumerableSurrogate(AVLTreeArrayRankList<KeyType> tree)
            {
                this.tree = tree;
            }
        ...
        public class RobustEnumerator : IEnumerator<EntryRankList<KeyType>>
        {
            ...
            public RobustEnumerator(AVLTreeArrayRankList<KeyType> tree)
            {
                this.tree = tree;
                Reset();
            }
        ...
        public class FastEnumerator : IEnumerator<EntryRankList<KeyType>>
        {
            ...
            public FastEnumerator(AVLTreeArrayRankList<KeyType> tree)
            {
                this.tree = tree;
                Reset();
            }
