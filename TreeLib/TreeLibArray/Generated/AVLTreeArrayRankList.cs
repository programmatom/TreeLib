...
namespace TreeLib
{
    ...
    public class AVLTreeArrayRankList<[Feature(Feature.Dict, Feature.Rank, Feature.RankMulti)] KeyType> :
        ...
        where KeyType : IComparable<KeyType>
    {
        ...
        [Storage(Storage.Array)]
        public AVLTreeArrayRankList([Feature(Feature.Dict, Feature.Rank, Feature.RankMulti)] IComparer<KeyType> comparer,uint capacity,AllocationMode allocationMode)
        {
        ...
        [Storage(Storage.Array)]
        [Feature(Feature.Dict, Feature.Rank, Feature.RankMulti)]
        public AVLTreeArrayRankList(uint capacity,AllocationMode allocationMode)
        ...
        /// </param>
        [Storage(Storage.Array)]
        public AVLTreeArrayRankList(uint capacity)
        ...
        [Storage(Storage.Array)]
        [Feature(Feature.Dict, Feature.Rank, Feature.RankMulti)]
        public AVLTreeArrayRankList(IComparer<KeyType> comparer)
        ...
        [Storage(Storage.Array)]
        public AVLTreeArrayRankList(AVLTreeArrayRankList<KeyType> original)
        {
...
uint countNew = checked(this.count + 1);
        ...
        private bool g_tree_remove_internal(
            [Feature(Feature.Dict, Feature.Rank, Feature.RankMulti)] KeyType key,            [Feature(Feature.Rank, Feature.RankMulti, Feature.Range, Feature.Range2)][Widen] int position,            [Feature(Feature.Dict, Feature.Rank)][Payload(Payload.None)]UpdatePredicate<KeyType> predicateList)
        {
            unchecked
            {
                if (root == Null)
        ...
        [Feature(Feature.Dict, Feature.Rank, Feature.RankMulti)]
        private bool Find(
            KeyType key,            out NodeRef match,            [Feature(Feature.Rank, Feature.RankMulti, Feature.Range, Feature.Range2)][Widen] out int xPositionMatch)
        {
            unchecked
            {
                match = Null;
        ...
        public struct RobustEnumerableSurrogate : IEnumerable<EntryRankList<KeyType>>
        {
            ...
            public RobustEnumerableSurrogate(AVLTreeArrayRankList<KeyType> tree,bool forward)
            {
                this.tree = tree;
            ...
            [Feature(Feature.Dict, Feature.Rank, Feature.RankMulti)]
            public RobustEnumerableSurrogate(AVLTreeArrayRankList<KeyType> tree,KeyType startKey,bool forward)
            {
                this.tree = tree;
                this.forward = forward;
        ...
        public struct FastEnumerableSurrogate : IEnumerable<EntryRankList<KeyType>>
        {
            ...
            public FastEnumerableSurrogate(AVLTreeArrayRankList<KeyType> tree,bool forward)
            {
                this.tree = tree;
                this.forward = forward;
            ...
            [Feature(Feature.Dict, Feature.Rank, Feature.RankMulti)]
            public FastEnumerableSurrogate(AVLTreeArrayRankList<KeyType> tree,KeyType startKey,bool forward)
            {
                this.tree = tree;
                this.forward = forward;
        ...
        public class RobustEnumerator :
            ...
            public RobustEnumerator(AVLTreeArrayRankList<KeyType> tree,bool forward)
            {
                this.tree = tree;
                this.forward = forward;
            ...
            [Feature(Feature.Dict, Feature.Rank, Feature.RankMulti)]
            public RobustEnumerator(AVLTreeArrayRankList<KeyType> tree,KeyType startKey,bool forward)
            {
                this.tree = tree;
                this.forward = forward;
        ...
        public class FastEnumerator :
            ...
            public FastEnumerator(AVLTreeArrayRankList<KeyType> tree,bool forward)
            {
                this.tree = tree;
                this.forward = forward;
            ...
            [Feature(Feature.Dict, Feature.Rank, Feature.RankMulti)]
            public FastEnumerator(AVLTreeArrayRankList<KeyType> tree,KeyType startKey,bool forward)
            {
                this.tree = tree;
                this.forward = forward;
        ...
        public object Clone()
        {
            return new AVLTreeArrayRankList<KeyType>(this);
        }
    }
}
