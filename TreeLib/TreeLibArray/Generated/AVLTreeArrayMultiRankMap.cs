...
namespace TreeLib
{
        ...
        where KeyType : IComparable<KeyType>
    {
        ...
        private NodeRef Null { get { return AVLTreeArrayMultiRankMap<KeyType, ValueType>._Null; } } // allow tree.Null or this.Null in all cases
...
uint countNew = checked(this.count + 1);
        ...
        [Feature(Feature.Dict, Feature.Rank, Feature.RankMulti)]
        private bool Find(            KeyType key,            out NodeRef match,            [Feature(Feature.Rank, Feature.RankMulti, Feature.Range, Feature.Range2)][Widen] out int xPositionMatch,            [Feature(Feature.RankMulti)][Widen] out int xLengthMatch)
        {
            unchecked
            {
                match = Null;
