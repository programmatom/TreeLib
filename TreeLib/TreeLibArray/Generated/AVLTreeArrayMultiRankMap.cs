...
uint countNew = checked(this.count + 1);
        ...
        public struct RobustEnumerableSurrogate : IEnumerable<EntryMultiRankMap<KeyType, ValueType>>
        {
            ...
            public RobustEnumerableSurrogate(AVLTreeArrayMultiRankMap<KeyType, ValueType> tree)
            {
                this.tree = tree;
            }
        ...
        public struct FastEnumerableSurrogate : IEnumerable<EntryMultiRankMap<KeyType, ValueType>>
        {
            ...
            public FastEnumerableSurrogate(AVLTreeArrayMultiRankMap<KeyType, ValueType> tree)
            {
                this.tree = tree;
            }
        ...
        public class RobustEnumerator : IEnumerator<EntryMultiRankMap<KeyType, ValueType>>
        {
            ...
            public RobustEnumerator(AVLTreeArrayMultiRankMap<KeyType, ValueType> tree)
            {
                this.tree = tree;
                Reset();
            }
        ...
        public class FastEnumerator : IEnumerator<EntryMultiRankMap<KeyType, ValueType>>
        {
            ...
            public FastEnumerator(AVLTreeArrayMultiRankMap<KeyType, ValueType> tree)
            {
                this.tree = tree;
                Reset();
            }
