...
namespace TreeLib
{
    ...
    /// </summary>
    public class AVLTreeArrayRangeList:
        ...
        ICloneable
    {
        ...
        private NodeRef Null { get { return AVLTreeArrayRangeList._Null; } } // allow tree.Null or this.Null in all cases
        ...
        [Storage(Storage.Array)]
        public AVLTreeArrayRangeList(uint capacity,AllocationMode allocationMode)
        {
        ...
        /// </param>
        [Storage(Storage.Array)]
        public AVLTreeArrayRangeList(uint capacity)
        ...
        [Storage(Storage.Array)]
        public AVLTreeArrayRangeList(AVLTreeArrayRangeList original)
        {
...
out length))
        ...
        private bool g_tree_insert_internal(            [Feature(Feature.Rank, Feature.RankMulti, Feature.Range, Feature.Range2)][Widen] int position,            [Feature(Feature.Rank, Feature.RankMulti, Feature.Range, Feature.Range2)][Widen] int xLength,            bool add,            bool update)
        {
            unchecked
            {
                if (root == Null)
...
uint countNew = checked(this.count + 1);
        ...
        {
            private readonly AVLTreeArrayRangeList tree;
            ...
            public RobustEnumerableSurrogate(AVLTreeArrayRangeList tree,bool forward)
            {
                this.tree = tree;
            ...
            [Feature(Feature.Range, Feature.Range2)]
            public RobustEnumerableSurrogate(AVLTreeArrayRangeList tree,[Widen] int startStart,bool forward)
            {
                this.tree = tree;
                this.forward = forward;
        ...
        public struct FastEnumerableSurrogate : IEnumerable<EntryRangeList>
        {
            ...
            public FastEnumerableSurrogate(AVLTreeArrayRangeList tree,bool forward)
            {
                this.tree = tree;
                this.forward = forward;
            ...
            [Feature(Feature.Range, Feature.Range2)]
            public FastEnumerableSurrogate(AVLTreeArrayRangeList tree,[Widen] int startStart,bool forward)
            {
                this.tree = tree;
                this.forward = forward;
        ...
        public class RobustEnumerator :
            ...
            [Feature(Feature.Range, Feature.Range2)]
            public RobustEnumerator(AVLTreeArrayRangeList tree,[Widen] int startStart,bool forward)
            {
                this.tree = tree;
                this.forward = forward;
        ...
        public class FastEnumerator :
            ...
            public FastEnumerator(AVLTreeArrayRangeList tree,bool forward)
            {
                this.tree = tree;
                this.forward = forward;
            ...
            [Feature(Feature.Range, Feature.Range2)]
            public FastEnumerator(AVLTreeArrayRangeList tree,[Widen] int startStart,bool forward)
            {
                this.tree = tree;
                this.forward = forward;
        ...
        public object Clone()
        {
            return new AVLTreeArrayRangeList(this);
        }
    }
}
