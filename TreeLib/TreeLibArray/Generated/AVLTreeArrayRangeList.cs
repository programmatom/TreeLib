...
uint countNew = checked(this.count + 1);
        ...
        public struct RobustEnumerableSurrogate : IEnumerable<EntryRangeList>
        {
            ...
            public RobustEnumerableSurrogate(AVLTreeArrayRangeList tree)
            {
                this.tree = tree;
            }
        ...
        public struct FastEnumerableSurrogate : IEnumerable<EntryRangeList>
        {
            ...
            public FastEnumerableSurrogate(AVLTreeArrayRangeList tree)
            {
                this.tree = tree;
            }
        ...
        public class RobustEnumerator : IEnumerator<EntryRangeList>
        {
            ...
            public RobustEnumerator(AVLTreeArrayRangeList tree)
            {
                this.tree = tree;
                Reset();
            }
        ...
        public class FastEnumerator : IEnumerator<EntryRangeList>
        {
            ...
            public FastEnumerator(AVLTreeArrayRangeList tree)
            {
                this.tree = tree;
                Reset();
            }
