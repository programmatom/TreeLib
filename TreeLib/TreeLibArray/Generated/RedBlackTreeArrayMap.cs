...
uint countNew;
        ...
        public struct RobustEnumerableSurrogate : IEnumerable<EntryMap<KeyType, ValueType>>
        {
            ...
            public RobustEnumerableSurrogate(RedBlackTreeArrayMap<KeyType, ValueType> tree)
            {
                this.tree = tree;
            }
        ...
        public struct FastEnumerableSurrogate : IEnumerable<EntryMap<KeyType, ValueType>>
        {
            ...
            public FastEnumerableSurrogate(RedBlackTreeArrayMap<KeyType, ValueType> tree)
            {
                this.tree = tree;
            }
        ...
        public class RobustEnumerator : IEnumerator<EntryMap<KeyType, ValueType>>
        {
            ...
            public RobustEnumerator(RedBlackTreeArrayMap<KeyType, ValueType> tree)
            {
                this.tree = tree;
                Reset();
            }
        ...
        public class FastEnumerator : IEnumerator<EntryMap<KeyType, ValueType>>
        {
            ...
            public FastEnumerator(RedBlackTreeArrayMap<KeyType, ValueType> tree)
            {
                this.tree = tree;
                Reset();
            }
