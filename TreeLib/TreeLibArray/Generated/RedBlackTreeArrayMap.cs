...
namespace TreeLib
{
    ...
    public class RedBlackTreeArrayMap<[Feature(Feature.Dict, Feature.Rank, Feature.RankMulti)] KeyType, [Payload(Payload.Value)] ValueType> :
        ...
        where KeyType : IComparable<KeyType>
    {
        ...
        [Storage(Storage.Array)]
        public RedBlackTreeArrayMap([Feature(Feature.Dict, Feature.Rank, Feature.RankMulti)] IComparer<KeyType> comparer,uint capacity,AllocationMode allocationMode)
        {
        ...
        [Storage(Storage.Array)]
        [Feature(Feature.Dict, Feature.Rank, Feature.RankMulti)]
        public RedBlackTreeArrayMap(uint capacity,AllocationMode allocationMode)
        ...
        /// </param>
        [Storage(Storage.Array)]
        public RedBlackTreeArrayMap(uint capacity)
        ...
        [Storage(Storage.Array)]
        [Feature(Feature.Dict, Feature.Rank, Feature.RankMulti)]
        public RedBlackTreeArrayMap(IComparer<KeyType> comparer)
        ...
        [Storage(Storage.Array)]
        public RedBlackTreeArrayMap(RedBlackTreeArrayMap<KeyType, ValueType> original)
        {
        ...
        private bool NearestLess(
            out NodeRef nearestNode,            [Feature(Feature.Dict, Feature.Rank, Feature.RankMulti)] KeyType key,            [Feature(Feature.Dict, Feature.Rank, Feature.RankMulti)] out KeyType nearestKey,            bool orEqual)
        {
...
uint countNew = checked(this.count + 1);
        ...
        {
            private readonly RedBlackTreeArrayMap<KeyType, ValueType> tree;
            ...
            public RobustEnumerableSurrogate(RedBlackTreeArrayMap<KeyType, ValueType> tree,bool forward)
            {
                this.tree = tree;
            ...
            [Feature(Feature.Dict, Feature.Rank, Feature.RankMulti)]
            public RobustEnumerableSurrogate(RedBlackTreeArrayMap<KeyType, ValueType> tree,KeyType startKey,bool forward)
            {
                this.tree = tree;
                this.forward = forward;
        ...
        public struct FastEnumerableSurrogate : IEnumerable<EntryMap<KeyType, ValueType>>
        {
            ...
            public FastEnumerableSurrogate(RedBlackTreeArrayMap<KeyType, ValueType> tree,bool forward)
            {
                this.tree = tree;
                this.forward = forward;
            ...
            [Feature(Feature.Dict, Feature.Rank, Feature.RankMulti)]
            public FastEnumerableSurrogate(RedBlackTreeArrayMap<KeyType, ValueType> tree,KeyType startKey,bool forward)
            {
                this.tree = tree;
                this.forward = forward;
            ...
            /*[Payload(Payload.Value)]*/ISetValue<ValueType>
        {
            ...
            public RobustEnumerator(RedBlackTreeArrayMap<KeyType, ValueType> tree,bool forward)
            {
                this.tree = tree;
                this.forward = forward;
            ...
            [Feature(Feature.Dict, Feature.Rank, Feature.RankMulti)]
            public RobustEnumerator(RedBlackTreeArrayMap<KeyType, ValueType> tree,KeyType startKey,bool forward)
            {
                this.tree = tree;
                this.forward = forward;
            ...
            /*[Payload(Payload.Value)]*/ISetValue<ValueType>
        {
            ...
            public FastEnumerator(RedBlackTreeArrayMap<KeyType, ValueType> tree,bool forward)
            {
                this.tree = tree;
                this.forward = forward;
            ...
            [Feature(Feature.Dict, Feature.Rank, Feature.RankMulti)]
            public FastEnumerator(RedBlackTreeArrayMap<KeyType, ValueType> tree,KeyType startKey,bool forward)
            {
                this.tree = tree;
                this.forward = forward;
        ...
        public object Clone()
        {
            return new RedBlackTreeArrayMap<KeyType, ValueType>(this);
        }
    }
}
