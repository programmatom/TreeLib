...
uint countNew = checked(this.count + 1);
        ...
        public struct RobustEnumerableSurrogate : IEnumerable<EntryRangeList>
        {
            ...
            [Feature(Feature.Range, Feature.Range2)]
            public RobustEnumerableSurrogate(SplayTreeArrayRangeList tree,[Widen] int startStart,bool forward)
            {
                this.tree = tree;
                this.forward = forward;
        ...
        public struct FastEnumerableSurrogate : IEnumerable<EntryRangeList>
        {
            ...
            [Feature(Feature.Range, Feature.Range2)]
            public FastEnumerableSurrogate(SplayTreeArrayRangeList tree,[Widen] int startStart,bool forward)
            {
                this.tree = tree;
                this.forward = forward;
        ...
        public class RobustEnumerator :
            ...
            [Feature(Feature.Range, Feature.Range2)]
            public RobustEnumerator(SplayTreeArrayRangeList tree,[Widen] int startStart,bool forward)
            {
                this.tree = tree;
                this.forward = forward;
        ...
        public class FastEnumerator :
            ...
            [Feature(Feature.Range, Feature.Range2)]
            public FastEnumerator(SplayTreeArrayRangeList tree,[Widen] int startStart,bool forward)
            {
                this.tree = tree;
                this.forward = forward;
