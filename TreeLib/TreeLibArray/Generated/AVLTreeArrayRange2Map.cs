...
namespace TreeLib
{
        ...
        IEnumerable
    {
        ...
        private NodeRef Null { get { return AVLTreeArrayRange2Map<ValueType>._Null; } } // allow tree.Null or this.Null in all cases
...
uint countNew = checked(this.count + 1);
        ...
        public struct RobustEnumerableSurrogate : IEnumerable<EntryRange2Map<ValueType>>
        {
            ...
            public RobustEnumerableSurrogate(AVLTreeArrayRange2Map<ValueType> tree)
            {
                this.tree = tree;
            }
        ...
        public struct FastEnumerableSurrogate : IEnumerable<EntryRange2Map<ValueType>>
        {
            ...
            public FastEnumerableSurrogate(AVLTreeArrayRange2Map<ValueType> tree)
            {
                this.tree = tree;
            }
        ...
        public class RobustEnumerator : IEnumerator<EntryRange2Map<ValueType>>
        {
            ...
            public RobustEnumerator(AVLTreeArrayRange2Map<ValueType> tree)
            {
                this.tree = tree;
                Reset();
            }
        ...
        public class FastEnumerator : IEnumerator<EntryRange2Map<ValueType>>
        {
            ...
            public FastEnumerator(AVLTreeArrayRange2Map<ValueType> tree)
            {
                this.tree = tree;
                Reset();
            }
