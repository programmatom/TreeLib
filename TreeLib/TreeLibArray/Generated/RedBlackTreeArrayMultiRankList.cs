...
uint countNew;
        ...
        public struct RobustEnumerableSurrogate : IEnumerable<EntryMultiRankList<KeyType>>
        {
            ...
            public RobustEnumerableSurrogate(RedBlackTreeArrayMultiRankList<KeyType> tree)
            {
                this.tree = tree;
            }
        ...
        public struct FastEnumerableSurrogate : IEnumerable<EntryMultiRankList<KeyType>>
        {
            ...
            public FastEnumerableSurrogate(RedBlackTreeArrayMultiRankList<KeyType> tree)
            {
                this.tree = tree;
            }
        ...
        public class RobustEnumerator : IEnumerator<EntryMultiRankList<KeyType>>
        {
            ...
            public RobustEnumerator(RedBlackTreeArrayMultiRankList<KeyType> tree)
            {
                this.tree = tree;
                Reset();
            }
        ...
        public class FastEnumerator : IEnumerator<EntryMultiRankList<KeyType>>
        {
            ...
            public FastEnumerator(RedBlackTreeArrayMultiRankList<KeyType> tree)
            {
                this.tree = tree;
                Reset();
            }
