...
namespace TreeLib
{
        ...
        IEnumerable
    {
        ...
        private NodeRef Null { get { return RedBlackTreeArrayRange2List._Null; } } // allow tree.Null or this.Null in all cases
...
uint countNew;
        ...
        public struct RobustEnumerableSurrogate : IEnumerable<EntryRange2List>
        {
            ...
            public RobustEnumerableSurrogate(RedBlackTreeArrayRange2List tree)
            {
                this.tree = tree;
            }
        ...
        public struct FastEnumerableSurrogate : IEnumerable<EntryRange2List>
        {
            ...
            public FastEnumerableSurrogate(RedBlackTreeArrayRange2List tree)
            {
                this.tree = tree;
            }
        ...
        public class RobustEnumerator : IEnumerator<EntryRange2List>
        {
            ...
            public RobustEnumerator(RedBlackTreeArrayRange2List tree)
            {
                this.tree = tree;
                Reset();
            }
        ...
        public class FastEnumerator : IEnumerator<EntryRange2List>
        {
            ...
            public FastEnumerator(RedBlackTreeArrayRange2List tree)
            {
                this.tree = tree;
                Reset();
            }
