...
uint countNew;
        ...
        public struct RobustEnumerableSurrogate : IEnumerable<EntryRange2Map<ValueType>>
        {
            ...
            public RobustEnumerableSurrogate(RedBlackTreeArrayRange2Map<ValueType> tree)
            {
                this.tree = tree;
            }
        ...
        public struct FastEnumerableSurrogate : IEnumerable<EntryRange2Map<ValueType>>
        {
            ...
            public FastEnumerableSurrogate(RedBlackTreeArrayRange2Map<ValueType> tree)
            {
                this.tree = tree;
            }
        ...
        public class RobustEnumerator : IEnumerator<EntryRange2Map<ValueType>>
        {
            ...
            public RobustEnumerator(RedBlackTreeArrayRange2Map<ValueType> tree)
            {
                this.tree = tree;
                Reset();
            }
        ...
        public class FastEnumerator : IEnumerator<EntryRange2Map<ValueType>>
        {
            ...
            public FastEnumerator(RedBlackTreeArrayRange2Map<ValueType> tree)
            {
                this.tree = tree;
                Reset();
            }
