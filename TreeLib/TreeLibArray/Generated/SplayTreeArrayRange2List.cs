...
uint countNew = checked(this.count + 1);
        ...
        public struct RobustEnumerableSurrogate : IEnumerable<EntryRange2List>
        {
            ...
            public RobustEnumerableSurrogate(SplayTreeArrayRange2List tree)
            {
                this.tree = tree;
            }
        ...
        public struct FastEnumerableSurrogate : IEnumerable<EntryRange2List>
        {
            ...
            public FastEnumerableSurrogate(SplayTreeArrayRange2List tree)
            {
                this.tree = tree;
            }
        ...
        public class RobustEnumerator : IEnumerator<EntryRange2List>
        {
            ...
            public RobustEnumerator(SplayTreeArrayRange2List tree)
            {
                this.tree = tree;
                Reset();
            }
        ...
        public class FastEnumerator : IEnumerator<EntryRange2List>
        {
            ...
            public FastEnumerator(SplayTreeArrayRange2List tree)
            {
                this.tree = tree;
                Reset();
            }
