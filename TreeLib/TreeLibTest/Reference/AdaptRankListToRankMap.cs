...
{
    public class AdaptRankListToRankMap<KeyType, ValueType> : IRankMap<KeyType, ValueType>, INonInvasiveTreeInspection, INonInvasiveMultiRankMapInspection where KeyType : IComparable<KeyType>
    {
