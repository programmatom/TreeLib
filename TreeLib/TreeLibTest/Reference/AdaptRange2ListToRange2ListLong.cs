...
namespace TreeLibTest
{
        ...
        INonInvasiveRange2MapInspection
    {
        ...
        {
            return inner.TryInsert(ToLong(start), side, ToLong(xLength), ToLong(yLength));
        }
        ...
        public bool TryGet(int start, Side side, out int otherStart, out int xLength, out int yLength)
        {
            ...
            long xLengthLong;
            long yLengthLong;
            bool f = inner.TryGet(ToLong(start), side, out otherStartLong, out xLengthLong, out yLengthLong);
        ...
        {
            inner.Insert(ToLong(start), side, ToLong(xLength), ToLong(yLength));
        }
        ...
        public void Get(int start, Side side, out int otherStart, out int xLength, out int yLength)
        {
            ...
            long xLengthLong;
            long yLengthLong;
            inner.Get(ToLong(start), side, out otherStartLong, out xLengthLong, out yLengthLong);
            otherStart = ToInt(otherStartLong);
            xLength = ToInt(xLengthLong);
            yLength = ToInt(yLengthLong);
        }
