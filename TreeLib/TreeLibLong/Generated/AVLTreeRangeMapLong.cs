...
namespace TreeLib
{
        ...
        ICloneable
    {
        ...
        private Node Null { get { return AVLTreeRangeMapLong<ValueType>._Null; } } // allow tree.Null or this.Null in all cases
        ...
        [Storage(Storage.Object)]
        public AVLTreeRangeMapLong(uint capacity,AllocationMode allocationMode)
        {
            this.root = Null;
        ...
        [Storage(Storage.Object)]
        public AVLTreeRangeMapLong(AVLTreeRangeMapLong<ValueType> original)
        {
...
out xLength)
        ...
        [Feature(Feature.Range, Feature.Range2)]
        public bool TrySet([Widen] long start,[Widen] long xLength,[Payload(Payload.Value)] ValueType value)
        {
            if (xLength < 0)
            {
                throw new ArgumentOutOfRangeException();
...
out length))
        ...
        [Feature(Feature.Range, Feature.Range2)]
        public void Set([Widen] long start,[Widen] long xLength,[Payload(Payload.Value)] ValueType value)
        {
        ...
        [Feature(Feature.RankMulti, Feature.Range, Feature.Range2)]
        [Rename("NearestLessOrEqualByRank", Feature.RankMulti)]
        public bool NearestLessOrEqual([Widen] long position,[Widen] out long nearestStart,[Widen] out long xLength,[Payload(Payload.Value)] out ValueType value)
        {
            xLength = 0;
            value = default(ValueType);
            Node nearestNode;
        ...
        [Feature(Feature.RankMulti, Feature.Range, Feature.Range2)]
        [Rename("NearestLessByRank", Feature.RankMulti)]
        public bool NearestLess([Widen] long position,[Widen] out long nearestStart,[Widen] out long xLength,[Payload(Payload.Value)] out ValueType value)
        {
            xLength = 0;
            value = default(ValueType);
            Node nearestNode;
        ...
        [Feature(Feature.RankMulti, Feature.Range, Feature.Range2)]
        [Rename("NearestGreaterOrEqualByRank", Feature.RankMulti)]
        public bool NearestGreaterOrEqual([Widen] long position,[Widen] out long nearestStart,[Widen] out long xLength,[Payload(Payload.Value)] out ValueType value)
        {
            xLength = 0;
            value = default(ValueType);
            Node nearestNode;
        ...
        [Feature(Feature.RankMulti, Feature.Range, Feature.Range2)]
        [Rename("NearestGreaterByRank", Feature.RankMulti)]
        public bool NearestGreater([Widen] long position,[Widen] out long nearestStart,[Widen] out long xLength,[Payload(Payload.Value)] out ValueType value)
        {
            xLength = 0;
            value = default(ValueType);
            Node nearestNode;
        ...
        [Feature(Feature.Range, Feature.Range2)]
        public void AdjustLength([Widen] long startIndex,[Widen] long xAdjust)
        {
            unchecked
            {
                Node node;
        ...
        private bool g_tree_insert_internal(            [Payload(Payload.Value)] ValueType value,            [Feature(Feature.Rank, Feature.RankMulti, Feature.Range, Feature.Range2)][Widen] long position,            [Feature(Feature.Rank, Feature.RankMulti, Feature.Range, Feature.Range2)][Widen] long xLength,            bool add,            bool update)
        {
            unchecked
            {
                if (root == Null)
        ...
        public IEnumerable<EntryRangeMapLong<ValueType>> GetEnumerable()
        {
            return new FastEnumerableSurrogate(this, true/*forward*/);
        }

        public IEnumerable<EntryRangeMapLong<ValueType>> GetEnumerable(bool forward)
        {
        ...
        public IEnumerable<EntryRangeMapLong<ValueType>> GetRobustEnumerable()
        {
            return new RobustEnumerableSurrogate(this, true/*forward*/);
        }

        public IEnumerable<EntryRangeMapLong<ValueType>> GetRobustEnumerable(bool forward)
        {
        ...
        /// </summary>
        /// <returns>An IEnumerable which can be used in a foreach statement</returns>
        public IEnumerable<EntryRangeMapLong<ValueType>> GetFastEnumerable()
        {
            return new FastEnumerableSurrogate(this, true/*forward*/);
        }

        public IEnumerable<EntryRangeMapLong<ValueType>> GetFastEnumerable(bool forward)
        {
            return new FastEnumerableSurrogate(this, forward);
        }
        ...
        [Feature(Feature.Range, Feature.Range2)]
        public IEnumerable<EntryRangeMapLong<ValueType>> GetEnumerable([Widen] long startAt)
        {
            return new RobustEnumerableSurrogate(this, startAt, true/*forward*/); // default
        }

        [Feature(Feature.Range, Feature.Range2)]
        public IEnumerable<EntryRangeMapLong<ValueType>> GetEnumerable([Widen] long startAt,bool forward)
        {
            return new RobustEnumerableSurrogate(this, startAt, forward); // default
        }

        [Feature(Feature.Range, Feature.Range2)]
        public IEnumerable<EntryRangeMapLong<ValueType>> GetFastEnumerable([Widen] long startAt)
        {
            return new FastEnumerableSurrogate(this, startAt, true/*forward*/);
        }

        [Feature(Feature.Range, Feature.Range2)]
        public IEnumerable<EntryRangeMapLong<ValueType>> GetFastEnumerable([Widen] long startAt,bool forward)
        {
            return new FastEnumerableSurrogate(this, startAt, forward);
        }

        [Feature(Feature.Range, Feature.Range2)]
        public IEnumerable<EntryRangeMapLong<ValueType>> GetRobustEnumerable([Widen] long startAt)
        {
            return new RobustEnumerableSurrogate(this, startAt, true/*forward*/);
        }

        [Feature(Feature.Range, Feature.Range2)]
        public IEnumerable<EntryRangeMapLong<ValueType>> GetRobustEnumerable([Widen] long startAt,bool forward)
        {
        ...
        {
            private readonly AVLTreeRangeMapLong<ValueType> tree;
            ...
            public RobustEnumerableSurrogate(AVLTreeRangeMapLong<ValueType> tree,bool forward)
            {
                this.tree = tree;
            ...
            [Feature(Feature.Range, Feature.Range2)]
            public RobustEnumerableSurrogate(AVLTreeRangeMapLong<ValueType> tree,[Widen] long startStart,bool forward)
            {
                this.tree = tree;
                this.forward = forward;
        ...
        public struct FastEnumerableSurrogate : IEnumerable<EntryRangeMapLong<ValueType>>
        {
            ...
            public FastEnumerableSurrogate(AVLTreeRangeMapLong<ValueType> tree,bool forward)
            {
                this.tree = tree;
                this.forward = forward;
            ...
            [Feature(Feature.Range, Feature.Range2)]
            public FastEnumerableSurrogate(AVLTreeRangeMapLong<ValueType> tree,[Widen] long startStart,bool forward)
            {
                this.tree = tree;
                this.forward = forward;
        ...
        public class RobustEnumerator :
            IEnumerator<EntryRangeMapLong<ValueType>>,
            /*[Payload(Payload.Value)]*/ISetValue<ValueType>
        {
            ...
            public RobustEnumerator(AVLTreeRangeMapLong<ValueType> tree,bool forward)
            {
                this.tree = tree;
                this.forward = forward;
            ...
            [Feature(Feature.Range, Feature.Range2)]
            public RobustEnumerator(AVLTreeRangeMapLong<ValueType> tree,[Widen] long startStart,bool forward)
            {
                this.tree = tree;
                this.forward = forward;
            ...
            /*[Payload(Payload.Value)]*/ISetValue<ValueType>
        {
            ...
            public FastEnumerator(AVLTreeRangeMapLong<ValueType> tree,bool forward)
            {
                this.tree = tree;
                this.forward = forward;
            ...
            [Feature(Feature.Range, Feature.Range2)]
            public FastEnumerator(AVLTreeRangeMapLong<ValueType> tree,[Widen] long startStart,bool forward)
            {
                this.tree = tree;
                this.forward = forward;
        ...
        public object Clone()
        {
            return new AVLTreeRangeMapLong<ValueType>(this);
        }
    }
}
