...
namespace TreeLib
{
    ...
    /// </summary>
    public class AVLTreeRange2ListLong:
        ...
        ICloneable
    {
        ...
        private Node Null { get { return AVLTreeRange2ListLong._Null; } } // allow tree.Null or this.Null in all cases
        ...
        [Storage(Storage.Object)]
        public AVLTreeRange2ListLong(uint capacity,AllocationMode allocationMode)
        {
            this.root = Null;
        ...
        [Storage(Storage.Object)]
        public AVLTreeRange2ListLong(AVLTreeRange2ListLong original)
        {
...
out length))
        ...
        {
            private readonly AVLTreeRange2ListLong tree;
            ...
            public RobustEnumerableSurrogate(AVLTreeRange2ListLong tree,bool forward)
            {
                this.tree = tree;
            ...
            [Feature(Feature.Range, Feature.Range2)]
            public RobustEnumerableSurrogate(AVLTreeRange2ListLong tree,[Widen] long startStart,[Feature(Feature.Range2)] [Const(Side.X, Feature.Range)] [SuppressConst(Feature.Range2)] Side side,bool forward)
            {
                this.tree = tree;
                this.forward = forward;
        ...
        public struct FastEnumerableSurrogate : IEnumerable<EntryRange2ListLong>
        {
            ...
            public FastEnumerableSurrogate(AVLTreeRange2ListLong tree,bool forward)
            {
                this.tree = tree;
                this.forward = forward;
            ...
            [Feature(Feature.Range, Feature.Range2)]
            public FastEnumerableSurrogate(AVLTreeRange2ListLong tree,[Widen] long startStart,[Feature(Feature.Range2)] [Const(Side.X, Feature.Range)] [SuppressConst(Feature.Range2)] Side side,bool forward)
            {
                this.tree = tree;
                this.forward = forward;
        ...
        public class RobustEnumerator :
            ...
            public RobustEnumerator(AVLTreeRange2ListLong tree,bool forward)
            {
                this.tree = tree;
                this.forward = forward;
            ...
            [Feature(Feature.Range, Feature.Range2)]
            public RobustEnumerator(AVLTreeRange2ListLong tree,[Widen] long startStart,[Feature(Feature.Range2)] [Const(Side.X, Feature.Range)] [SuppressConst(Feature.Range2)] Side side,bool forward)
            {
                this.tree = tree;
                this.forward = forward;
        ...
        public class FastEnumerator :
            ...
            public FastEnumerator(AVLTreeRange2ListLong tree,bool forward)
            {
                this.tree = tree;
                this.forward = forward;
            ...
            [Feature(Feature.Range, Feature.Range2)]
            public FastEnumerator(AVLTreeRange2ListLong tree,[Widen] long startStart,[Feature(Feature.Range2)] [Const(Side.X, Feature.Range)] [SuppressConst(Feature.Range2)] Side side,bool forward)
            {
                this.tree = tree;
                this.forward = forward;
        ...
        public object Clone()
        {
            return new AVLTreeRange2ListLong(this);
        }
    }
}
