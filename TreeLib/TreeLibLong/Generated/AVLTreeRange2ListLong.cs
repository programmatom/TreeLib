...
out length))
        ...
        public struct RobustEnumerableSurrogate : IEnumerable<EntryRange2ListLong>
        {
            ...
            public RobustEnumerableSurrogate(AVLTreeRange2ListLong tree)
            {
                this.tree = tree;
            }
        ...
        public struct FastEnumerableSurrogate : IEnumerable<EntryRange2ListLong>
        {
            ...
            public FastEnumerableSurrogate(AVLTreeRange2ListLong tree)
            {
                this.tree = tree;
            }
        ...
        public class RobustEnumerator : IEnumerator<EntryRange2ListLong>
        {
            ...
            public RobustEnumerator(AVLTreeRange2ListLong tree)
            {
                this.tree = tree;
                Reset();
            }
        ...
        public class FastEnumerator : IEnumerator<EntryRange2ListLong>
        {
            ...
            public FastEnumerator(AVLTreeRange2ListLong tree)
            {
                this.tree = tree;
                Reset();
            }
