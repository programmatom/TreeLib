...
namespace TreeLib
{
        ...
        ICloneable
    {
        ...
        private bool InsertUpdateInternal(            [Payload(Payload.Value)] ValueType value,            [Feature(Feature.Rank, Feature.RankMulti, Feature.Range, Feature.Range2)][Widen] long position,            [Feature(Feature.Rank, Feature.RankMulti, Feature.Range, Feature.Range2)][Widen] long xLength,            bool add,            bool update)
        {
        ...
        private bool DeleteInternal(            [Feature(Feature.Rank, Feature.RankMulti, Feature.Range, Feature.Range2)][Widen] long position)
        {
            unchecked
            {
                if (root == Null)
        ...
        public struct RobustEnumerableSurrogate : IEnumerable<EntryRangeMapLong<ValueType>>
        {
            ...
            public RobustEnumerableSurrogate(RedBlackTreeRangeMapLong<ValueType> tree,bool forward)
            {
                this.tree = tree;
            ...
            [Feature(Feature.Range, Feature.Range2)]
            public RobustEnumerableSurrogate(RedBlackTreeRangeMapLong<ValueType> tree,[Widen] long startStart,bool forward)
            {
                this.tree = tree;
                this.forward = forward;
        ...
        public struct FastEnumerableSurrogate : IEnumerable<EntryRangeMapLong<ValueType>>
        {
            ...
            public FastEnumerableSurrogate(RedBlackTreeRangeMapLong<ValueType> tree,bool forward)
            {
                this.tree = tree;
                this.forward = forward;
            ...
            [Feature(Feature.Range, Feature.Range2)]
            public FastEnumerableSurrogate(RedBlackTreeRangeMapLong<ValueType> tree,[Widen] long startStart,bool forward)
            {
                this.tree = tree;
                this.forward = forward;
            ...
            /*[Payload(Payload.Value)]*/ISetValue<ValueType>
        {
            ...
            public RobustEnumerator(RedBlackTreeRangeMapLong<ValueType> tree,bool forward)
            {
                this.tree = tree;
                this.forward = forward;
            ...
            [Feature(Feature.Range, Feature.Range2)]
            public RobustEnumerator(RedBlackTreeRangeMapLong<ValueType> tree,[Widen] long startStart,bool forward)
            {
                this.tree = tree;
                this.forward = forward;
            ...
            /*[Payload(Payload.Value)]*/ISetValue<ValueType>
        {
            ...
            [Feature(Feature.Range, Feature.Range2)]
            public FastEnumerator(RedBlackTreeRangeMapLong<ValueType> tree,[Widen] long startStart,bool forward)
            {
                this.tree = tree;
                this.forward = forward;
        ...
        public object Clone()
        {
            return new RedBlackTreeRangeMapLong<ValueType>(this);
        }
    }
}
