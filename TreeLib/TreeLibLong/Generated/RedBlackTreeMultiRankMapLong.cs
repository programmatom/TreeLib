...
namespace TreeLib
{
        ...
        where KeyType : IComparable<KeyType>
    {
        ...
        public struct RobustEnumerableSurrogate : IEnumerable<EntryMultiRankMapLong<KeyType, ValueType>>
        {
            ...
            public RobustEnumerableSurrogate(RedBlackTreeMultiRankMapLong<KeyType, ValueType> tree)
            {
                this.tree = tree;
            }
        ...
        public struct FastEnumerableSurrogate : IEnumerable<EntryMultiRankMapLong<KeyType, ValueType>>
        {
            ...
            public FastEnumerableSurrogate(RedBlackTreeMultiRankMapLong<KeyType, ValueType> tree)
            {
                this.tree = tree;
            }
        ...
        /// </summary>
        public class RobustEnumerator : IEnumerator<EntryMultiRankMapLong<KeyType, ValueType>>
        {
            private readonly RedBlackTreeMultiRankMapLong<KeyType, ValueType> tree;
            ...
            public RobustEnumerator(RedBlackTreeMultiRankMapLong<KeyType, ValueType> tree)
            {
                this.tree = tree;
                Reset();
            }
        ...
        /// </summary>
        public class FastEnumerator : IEnumerator<EntryMultiRankMapLong<KeyType, ValueType>>
        {
            private readonly RedBlackTreeMultiRankMapLong<KeyType, ValueType> tree;
            private ushort version;
            ...
            public FastEnumerator(RedBlackTreeMultiRankMapLong<KeyType, ValueType> tree)
            {
                this.tree = tree;
                Reset();
            }
