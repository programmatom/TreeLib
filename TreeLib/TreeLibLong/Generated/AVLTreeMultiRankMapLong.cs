...
/*[Feature(Feature.RankMulti)]*/out xLength))
        ...
        public struct RobustEnumerableSurrogate : IEnumerable<EntryMultiRankMapLong<KeyType, ValueType>>
        {
            ...
            public RobustEnumerableSurrogate(AVLTreeMultiRankMapLong<KeyType, ValueType> tree)
            {
                this.tree = tree;
            }
        ...
        public struct FastEnumerableSurrogate : IEnumerable<EntryMultiRankMapLong<KeyType, ValueType>>
        {
            ...
            public FastEnumerableSurrogate(AVLTreeMultiRankMapLong<KeyType, ValueType> tree)
            {
                this.tree = tree;
            }
        ...
        public class RobustEnumerator : IEnumerator<EntryMultiRankMapLong<KeyType, ValueType>>
        {
            ...
            public RobustEnumerator(AVLTreeMultiRankMapLong<KeyType, ValueType> tree)
            {
                this.tree = tree;
                Reset();
            }
        ...
        public class FastEnumerator : IEnumerator<EntryMultiRankMapLong<KeyType, ValueType>>
        {
            ...
            public FastEnumerator(AVLTreeMultiRankMapLong<KeyType, ValueType> tree)
            {
                this.tree = tree;
                Reset();
            }
