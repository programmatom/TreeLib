...
namespace TreeLib
{
        ...
        ICloneable
    {
        ...
        public struct RobustEnumerableSurrogate : IEnumerable<EntryRangeMapLong<ValueType>>
        {
            ...
            public RobustEnumerableSurrogate(SplayTreeRangeMapLong<ValueType> tree,bool forward)
            {
                this.tree = tree;
            ...
            [Feature(Feature.Range, Feature.Range2)]
            public RobustEnumerableSurrogate(SplayTreeRangeMapLong<ValueType> tree,[Widen] long startStart,bool forward)
            {
                this.tree = tree;
                this.forward = forward;
        ...
        public struct FastEnumerableSurrogate : IEnumerable<EntryRangeMapLong<ValueType>>
        {
            ...
            public FastEnumerableSurrogate(SplayTreeRangeMapLong<ValueType> tree,bool forward)
            {
                this.tree = tree;
                this.forward = forward;
            ...
            [Feature(Feature.Range, Feature.Range2)]
            public FastEnumerableSurrogate(SplayTreeRangeMapLong<ValueType> tree,[Widen] long startStart,bool forward)
            {
                this.tree = tree;
                this.forward = forward;
            ...
            /*[Payload(Payload.Value)]*/ISetValue<ValueType>
        {
            ...
            public RobustEnumerator(SplayTreeRangeMapLong<ValueType> tree,bool forward)
            {
                this.tree = tree;
                this.forward = forward;
            ...
            [Feature(Feature.Range, Feature.Range2)]
            public RobustEnumerator(SplayTreeRangeMapLong<ValueType> tree,[Widen] long startStart,bool forward)
            {
                this.tree = tree;
                this.forward = forward;
            ...
            /*[Payload(Payload.Value)]*/ISetValue<ValueType>
        {
            ...
            public FastEnumerator(SplayTreeRangeMapLong<ValueType> tree,bool forward)
            {
                this.tree = tree;
                this.forward = forward;
            ...
            [Feature(Feature.Range, Feature.Range2)]
            public FastEnumerator(SplayTreeRangeMapLong<ValueType> tree,[Widen] long startStart,bool forward)
            {
                this.tree = tree;
                this.forward = forward;
        ...
        public object Clone()
        {
            return new SplayTreeRangeMapLong<ValueType>(this);
        }
    }
}
