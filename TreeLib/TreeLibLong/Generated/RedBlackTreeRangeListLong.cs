...
namespace TreeLib
{
        ...
        ICloneable
    {
        ...
        private Node Null { get { return RedBlackTreeRangeListLong._Null; } } // allow tree.Null or this.Null in all cases
        ...
        /// </summary>
        [Storage(Storage.Object)]
        public RedBlackTreeRangeListLong()
        ...
        [Storage(Storage.Object)]
        public RedBlackTreeRangeListLong(RedBlackTreeRangeListLong original)
        {
        ...
        [Feature(Feature.Range, Feature.Range2)]
        public bool TrySet([Widen] long start,[Widen] long xLength)
        {
            if (xLength < 0)
            {
                throw new ArgumentOutOfRangeException();
        ...
        [Feature(Feature.Range, Feature.Range2)]
        public void Set([Widen] long start,[Widen] long xLength)
        {
        ...
        private bool InsertUpdateInternal(            [Feature(Feature.Rank, Feature.RankMulti, Feature.Range, Feature.Range2)][Widen] long position,            [Feature(Feature.Rank, Feature.RankMulti, Feature.Range, Feature.Range2)][Widen] long xLength,            bool add,            bool update)
        {
        ...
        public object Clone()
        {
            return new RedBlackTreeRangeListLong(this);
        }
    }
}
