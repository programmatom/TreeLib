...
namespace TreeLib
{
        ...
        ICloneable
    {
        ...
        public struct RobustEnumerableSurrogate : IEnumerable<EntryRangeListLong>
        {
            ...
            public RobustEnumerableSurrogate(SplayTreeRangeListLong tree)
            {
                this.tree = tree;
            }
        ...
        public struct FastEnumerableSurrogate : IEnumerable<EntryRangeListLong>
        {
            ...
            public FastEnumerableSurrogate(SplayTreeRangeListLong tree)
            {
                this.tree = tree;
            }
        ...
        public class RobustEnumerator : IEnumerator<EntryRangeListLong>
        {
            ...
            public RobustEnumerator(SplayTreeRangeListLong tree)
            {
                this.tree = tree;
                Reset();
            }
        ...
        public class FastEnumerator : IEnumerator<EntryRangeListLong>
        {
            ...
            public FastEnumerator(SplayTreeRangeListLong tree)
            {
                this.tree = tree;
                Reset();
            }
