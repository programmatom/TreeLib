...
namespace TreeLib
{
        ...
        ICloneable
    {
        ...
        public struct RobustEnumerableSurrogate : IEnumerable<EntryRange2ListLong>
        {
            ...
            public RobustEnumerableSurrogate(SplayTreeRange2ListLong tree)
            {
                this.tree = tree;
            }
        ...
        public struct FastEnumerableSurrogate : IEnumerable<EntryRange2ListLong>
        {
            ...
            public FastEnumerableSurrogate(SplayTreeRange2ListLong tree)
            {
                this.tree = tree;
            }
        ...
        /// </summary>
        public class RobustEnumerator : IEnumerator<EntryRange2ListLong>
        {
            private readonly SplayTreeRange2ListLong tree;
            ...
            public RobustEnumerator(SplayTreeRange2ListLong tree)
            {
                this.tree = tree;
                Reset();
            }
        ...
        /// </summary>
        public class FastEnumerator : IEnumerator<EntryRange2ListLong>
        {
            private readonly SplayTreeRange2ListLong tree;
            private ushort version;
            ...
            public FastEnumerator(SplayTreeRange2ListLong tree)
            {
                this.tree = tree;
                Reset();
            }
