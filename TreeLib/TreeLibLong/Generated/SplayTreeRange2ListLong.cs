...
namespace TreeLib
{
        ...
        IEnumerable
    {
        ...
        /// <returns>true if a range was found starting at the specified index and updated</returns>
        [Feature(Feature.Range, Feature.Range2)]
        public bool TryGet([Widen] long start,[Feature(Feature.Range2)] [Const(Side.X, Feature.Range)] [SuppressConst(Feature.Range2)] Side side,[Feature(Feature.Range2)][Widen] out long otherStart,[Widen] out long xLength,[Feature(Feature.Range2)][Widen] out long yLength)
        {
            unchecked
            {
                if (root != Nil)
        ...
        [Feature(Feature.Range, Feature.Range2)]
        private bool NearestLess([Widen] long position,[Feature(Feature.Range2)] [Const(Side.X, Feature.Range)] [SuppressConst(Feature.Range2)] Side side,[Widen] out long nearestStart,bool orEqual)
        {
            if (root != Nil)
            {
        ...
        [Feature(Feature.Range, Feature.Range2)]
        private bool NearestGreater([Widen] long position,[Feature(Feature.Range2)] [Const(Side.X, Feature.Range)] [SuppressConst(Feature.Range2)] Side side,[Widen] out long nearestStart,bool orEqual)
        {
            if (root != Nil)
            {
                Splay2(ref root, position, /*[Feature(Feature.Range2)]*/side);
