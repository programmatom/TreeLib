...
namespace TreeLib
{
    ...
    /// </summary>
    public class SplayTreeRange2ListLong:
        ...
        ICloneable
    {
        ...
        [Storage(Storage.Object)]
        public SplayTreeRange2ListLong(uint capacity, AllocationMode allocationMode)
        {
            this.root = Nil;
        ...
        /// </summary>
        [Storage(Storage.Object)]
        public SplayTreeRange2ListLong()
        ...
        [Storage(Storage.Object)]
        public SplayTreeRange2ListLong(SplayTreeRange2ListLong original)
        {
        ...
        /// <exception cref="OverflowException">the sum of lengths would have exceeded Int64.MaxValue on either side</exception>
        [Feature(Feature.Range, Feature.Range2)]
        public void Insert([Widen] long start,[Feature(Feature.Range2)] Side side,[Widen] long xLength,[Feature(Feature.Range2)][Widen] long yLength)
        {
        ...
        /// <exception cref="ArgumentException">there is no range starting at the specified index on the specified side</exception>
        [Feature(Feature.Range, Feature.Range2)]
        public void Get([Widen] long start,[Feature(Feature.Range2)] Side side,[Feature(Feature.Range2)][Widen] out long otherStart,[Widen] out long xLength,[Feature(Feature.Range2)][Widen] out long yLength)
        {
        ...
        public bool NearestLessOrEqual([Widen] long position,[Feature(Feature.Range2)] Side side,[Widen] out long nearestStart,[Feature(Feature.Range2)][Widen] out long otherStart,[Widen] out long xLength,[Feature(Feature.Range2)][Widen] out long yLength)
        {
            otherStart = 0;
            xLength = 0;
            yLength = 0;
        ...
        public bool NearestLess([Widen] long position,[Feature(Feature.Range2)] Side side,[Widen] out long nearestStart,[Feature(Feature.Range2)][Widen] out long otherStart,[Widen] out long xLength,[Feature(Feature.Range2)][Widen] out long yLength)
        {
            otherStart = 0;
            xLength = 0;
            yLength = 0;
        ...
        public bool NearestGreaterOrEqual([Widen] long position,[Feature(Feature.Range2)] Side side,[Widen] out long nearestStart,[Feature(Feature.Range2)][Widen] out long otherStart,[Widen] out long xLength,[Feature(Feature.Range2)][Widen] out long yLength)
        {
        ...
        public bool NearestGreater([Widen] long position,[Feature(Feature.Range2)] Side side,[Widen] out long nearestStart,[Feature(Feature.Range2)][Widen] out long otherStart,[Widen] out long xLength,[Feature(Feature.Range2)][Widen] out long yLength)
        {
            otherStart = side == Side.X ? this.yExtent : this.xExtent;
            xLength = 0;
            yLength = 0;
        ...
        {
            private readonly SplayTreeRange2ListLong tree;
            ...
            public RobustEnumerableSurrogate(SplayTreeRange2ListLong tree, bool forward)
            {
                this.tree = tree;
            ...
            [Feature(Feature.Range, Feature.Range2)]
            public RobustEnumerableSurrogate(SplayTreeRange2ListLong tree,[Widen] long startStart,[Feature(Feature.Range2)] [Const(Side.X, Feature.Range)] [SuppressConst(Feature.Range2)] Side side, bool forward)
            {
                this.tree = tree;
                this.forward = forward;
        ...
        public struct FastEnumerableSurrogate : IEnumerable<EntryRange2ListLong>
        {
            ...
            public FastEnumerableSurrogate(SplayTreeRange2ListLong tree, bool forward)
            {
                this.tree = tree;
                this.forward = forward;
            ...
            [Feature(Feature.Range, Feature.Range2)]
            public FastEnumerableSurrogate(SplayTreeRange2ListLong tree,[Widen] long startStart,[Feature(Feature.Range2)] [Const(Side.X, Feature.Range)] [SuppressConst(Feature.Range2)] Side side, bool forward)
            {
                this.tree = tree;
                this.forward = forward;
        ...
        public class RobustEnumerator :
            ...
            [Feature(Feature.Range, Feature.Range2)]
            public RobustEnumerator(SplayTreeRange2ListLong tree,[Widen] long startStart,[Feature(Feature.Range2)] [Const(Side.X, Feature.Range)] [SuppressConst(Feature.Range2)] Side side, bool forward)
            {
                this.tree = tree;
                this.forward = forward;
        ...
        public class FastEnumerator :
            ...
            public FastEnumerator(SplayTreeRange2ListLong tree, bool forward)
            {
                this.tree = tree;
                this.forward = forward;
            ...
            [Feature(Feature.Range, Feature.Range2)]
            public FastEnumerator(SplayTreeRange2ListLong tree,[Widen] long startStart,[Feature(Feature.Range2)] [Const(Side.X, Feature.Range)] [SuppressConst(Feature.Range2)] Side side, bool forward)
            {
                this.tree = tree;
                this.forward = forward;
            ...
            private void Push(STuple<Node,/*[Feature(Feature.Rank, Feature.RankMulti, Feature.Range, Feature.Range2)]*//*[Widen]*/long,/*[Feature(Feature.Range2)]*//*[Widen]*/long> item)
            {
            ...
            private STuple<Node,/*[Feature(Feature.Rank, Feature.RankMulti, Feature.Range, Feature.Range2)]*//*[Widen]*/long,/*[Feature(Feature.Range2)]*//*[Widen]*/long> Pop()
            {
            ...
            public void Reset()
            {
                unchecked
                {
                    ...
                    while (node != tree.Nil)
                    {
                        ...
                        {
                            Push(new STuple<Node,/*[Feature(Feature.Rank, Feature.RankMulti, Feature.Range, Feature.Range2)]*//*[Widen]*/long,/*[Feature(Feature.Range2)]*//*[Widen]*/long>(
                                node,
        ...
        public object Clone()
        {
            return new SplayTreeRange2ListLong(this);
        }
    }
}
