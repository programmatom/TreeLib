...
out xPosition))
        ...
        public struct RobustEnumerableSurrogate : IEnumerable<EntryRankMapLong<KeyType, ValueType>>
        {
            ...
            public RobustEnumerableSurrogate(AVLTreeRankMapLong<KeyType, ValueType> tree)
            {
                this.tree = tree;
            }
        ...
        public struct FastEnumerableSurrogate : IEnumerable<EntryRankMapLong<KeyType, ValueType>>
        {
            ...
            public FastEnumerableSurrogate(AVLTreeRankMapLong<KeyType, ValueType> tree)
            {
                this.tree = tree;
            }
        ...
        public class RobustEnumerator : IEnumerator<EntryRankMapLong<KeyType, ValueType>>
        {
            ...
            public RobustEnumerator(AVLTreeRankMapLong<KeyType, ValueType> tree)
            {
                this.tree = tree;
                Reset();
            }
        ...
        public class FastEnumerator : IEnumerator<EntryRankMapLong<KeyType, ValueType>>
        {
            ...
            public FastEnumerator(AVLTreeRankMapLong<KeyType, ValueType> tree)
            {
                this.tree = tree;
                Reset();
            }
